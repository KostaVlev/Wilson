...
namespace Wilson.Web.Seed
{
    ...
    public static class CompaniesDbSeeder
    {
        ...
        private static IEnumerable<Location> projectLocations;
        ...
        //private static void SeedProjectLocations(CompanyDbContext db, bool hasLocations, out IEnumerable<Location> projectLocations)
        //{
        //    if (!hasLocations)
        //    {
        //        projectLocations = new List<Location>()
        //        {
        //            new Location()
        //            {
        //                Country = "Bulgaria",
